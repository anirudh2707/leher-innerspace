      ...
      <section id="noise" className="leher-section max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16 scroll-mt-12">
        <FadeInSection>
          ...
          <p className="leher-body text-muted-foreground text-base md:text-lg leading-relaxed mb-4">
            ...
            <span className="text-foreground font-medium"> Leher — meaning wave — </span>
            comes from a simple understanding: emotions don’t stay still. They move, rise, fall, and return.
              ...
              <div
                ...
                onClick={() =>
                  setSelectedFounder({
                    ...
                    role: "Founder",
                    img: ishikaImg,
                    bio: "I’m Ishika Ranawat, MSc Clinical Psychology. Most people don’t struggle loudly—they struggle quietly while still showing up every day. I kept noticing what goes unseen: overthinking, emotional exhaustion, a sense of disconnection. What we don’t express doesn’t disappear—it quietly shapes us. Leher creates a space where emotions can be felt, understood, and gently explored — just as they are.",
              ...
              <div
                ...
                onClick={() =>
                  setSelectedFounder({
                    ...
                    img: prishaImg,
                    bio: "Hi, my name is Prisha Thakkar. I've completed my MSc in Clinical Psychology from MIT ADT University. In the past year and a half, I have worked closely with children, adolescents, and caregivers facing emotional, behavioural, and adjustment-related challenges.  Through Leher, I wish to create a space that is safe, respectful, and youth-friendly — where mental health conversations are heard and addressed with sensitivity, professionalism, and ethical care.",
